...
export const STANDARD_ARTIFACTS = [
  ...
  {
    key: "war-kennel-drum",
    name: "War Kennel Drum",
    desc: "Monsters gain +1 SPD.",
    cost: { currency: "essence", amount: 26 },
    tags: ["monster"],
    maxCopies: 2,
    unlockDay: 12,
    mods: { monsterSpd: 1 },
  },
  {
    key: "bloodcall-bell",
    name: "Bloodcall Bell",
    desc: "Defenders in Blood-linked monster rooms gain +1 ATK.",
    cost: { currency: "essence", amount: 24 },
    tags: ["blood", "monster"],
    maxCopies: 1,
    unlockDay: 16,
    mods: { bloodLinkedMonsterAtk: 1 },
  },
  {
    key: "sealhammer",
    name: "Sealhammer",
    desc: "Ward-linked traps apply +1 Weaken duration.",
    cost: { currency: "essence", amount: 24 },
    tags: ["ward", "trap"],
    maxCopies: 1,
    unlockDay: 16,
    mods: { wardLinkedWeakenDuration: 1 },
  },
  {
    key: "false-trail-reliquary",
    name: "False Trail Reliquary",
    desc: "Reveal -1 invader at battle start (min 0).",
    cost: { currency: "soulshards", amount: 26 },
    tags: ["scouting", "expedition"],
    maxCopies: 1,
    unlockDay: 18,
    mods: { scoutRevealPenalty: 1 },
  },
  {
    key: "ossuary-spur",
    name: "Ossuary Spur",
    desc: "Hero deaths in Blood-linked rooms grant +1 Soulshard.",
    cost: { currency: "soulshards", amount: 24 },
    tags: ["blood", "economy"],
    maxCopies: 1,
    unlockDay: 20,
    mods: { bloodLinkedSoulshardOnKill: 1 },
  },
  {
    key: "surveyor-ledger",
    name: "Surveyor's Ledger",
    desc: "Upgrade Dungeon costs 20 less Essence.",
    cost: { currency: "soulshards", amount: 28 },
    tags: ["management", "economy"],
    maxCopies: 1,
    unlockDay: 22,
    mods: { dungeonUpgradeDiscount: 20 },
  },
  {
    key: "ashen-compass",
    name: "Ashen Compass",
    desc: "During Nihaza's Ash Trial, defending monsters gain +1 DEF.",
    cost: { currency: "essence", amount: 28 },
    tags: ["ash", "monster"],
    maxCopies: 1,
    unlockDay: 24,
    mods: { ashTrialMonsterDef: 1 },
  },
  {
    key: "breach-chains",
    name: "Breach Chains",
    desc: "During Nihaza's Ash Trial, traps start each raid with +1 charge.",
    cost: { currency: "essence", amount: 28 },
    tags: ["ash", "trap"],
    maxCopies: 1,
    unlockDay: 26,
    mods: { ashTrialTrapChargeBonus: 1 },
  },
  {
    key: "trail-chalk",
    name: "Trail Chalk",
    desc: "Defenders in Hunt-linked monster rooms gain +1 SPD.",
    cost: { currency: "essence", amount: 24 },
    tags: ["hunt", "monster"],
    maxCopies: 1,
    unlockDay: 28,
    mods: { huntLinkedMonsterSpd: 1 },
  },
  {
    key: "harrowing-banner",
    name: "Harrowing Banner",
    desc: "Monsters deal +1 damage to Marked heroes.",
    cost: { currency: "essence", amount: 26 },
    tags: ["monster", "control"],
    maxCopies: 1,
    unlockDay: 30,
    mods: { monsterBonusVsMarked: 1 },
  },
  {
    key: "black-catechism",
    name: "Black Catechism",
    desc: "Doctrine upgrades cost 3 less of their currency.",
    cost: { currency: "essence", amount: 30 },
    tags: ["doctrine", "economy"],
    maxCopies: 1,
    unlockDay: 32,
    mods: { doctrineCostReduction: 3 },
  },
  {
    key: "crucible-tongs",
    name: "Crucible Tongs",
    desc: "Fusion costs 2 fewer Darkcrystals (min 1).",
    cost: { currency: "soulshards", amount: 28 },
    tags: ["fusion", "economy"],
    maxCopies: 1,
    unlockDay: 36,
    mods: { fusionCostReduction: 2 },
  },
];
